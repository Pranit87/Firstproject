  ...
  return (
    <div>
      <Form.Group className="inner bg-white my-4 px-4 py-4 mx-4 rounded shadow font">
        <span className="VMS">SUPPLIER CREDENTIAL FORMS</span>
        ...
        <Row className="my-3">
          ...
          <Col sm={3}>
            <FormControl
              ...
              name="All_accounts"
            >
              <option value="red">All Accounts</option>
            </FormControl>
          </Col>
          ...
          <Col sm={3}>
            <FormControl
              ...
              name="All_accounts"
            >
              <option value="red">All Account Managers</option>
            </FormControl>
          </Col>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>CREATE VMS CLIENT LOGINS</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <AddForm2 />
        </Modal.Body>
